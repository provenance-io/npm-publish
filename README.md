# npm-publish
Provenance Blockchain API NPM publishing container

<p align="center">
  <img src="https://raw.githubusercontent.com/provenance-io/provenance/main/docs/logo.svg" width="80"><br />
</p>

This repository contains the boilerplate Typescript transpiling code generated by `telescope generate`
([osmosis-labs/telescope](https://github.com/osmosis-labs/telescope)) that is bundled into a docker image
`provenanceio/npm-publish` for use in the  [provenance](https://github.com/provenance-io/provenance) CI release workflows.
It will transpile the [provenance](https://github.com/provenance-io/provenance) Protobuf API into Typescript and publish it as a module to NPM.

Note: this repository does not contain any generated sources.
